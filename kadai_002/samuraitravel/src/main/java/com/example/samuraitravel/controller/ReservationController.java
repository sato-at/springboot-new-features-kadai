...
public class ReservationController {
	...
	// 予約フォームの入力内容をチェックし、問題がなければ予約内容の確認ページにリダイレクトさせる
	...
	// input()メソッドから渡されたReservationInputFormオブジェクトをもとにReservationRegisterFormオブジェクトを生成し、予約内容の確認ページを表示する
	...
	/*  
	// フォーム(ReservationRegisterForm)の送信先
